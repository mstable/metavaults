 ...
 * @dev     The contract has a delayed upgradability. The Governor can propose a new implementation
...
contract DelayedProxyAdmin is ImmutableModule {
    ...
    struct Request {
        ...
        uint32 timestamp; // Timestamp when upgrade request is proposed
    ...
    function proposeUpgrade(
        ...
        request.data = _data;
        request.timestamp = SafeCast.toUint32(block.timestamp);
